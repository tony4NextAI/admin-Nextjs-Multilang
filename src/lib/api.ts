...
export const API_BASE_URL = process.env.NEXT_PUBLIC_API_BASE_URL || "http://65.109.108.95:3001/api/";
...
export const ApiPath = {
  ...
  createLiveStream: "admin/live-stream",
  updateLiveStream: "admin/live-stream",
